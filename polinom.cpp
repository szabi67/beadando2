...
struct polinom            //ez lesz a structom
{
    vector<double> egyutthatok;   // csinálok egy üres vektort bele
  
    polinom() {}                      // default konstruktor

    polinom(const vector<double>& a) : egyutthatok(a) {}  //vektor konstruktor

    polinom(const polinom& cpy): egyutthatok{cpy.egyutthatok}{}     //copy konstruktor

    polinom(const int& x): egyutthatok(x, 0.0) {}    //sima számos kontsruktor
